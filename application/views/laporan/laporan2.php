...
<html lang="id">
    <head>
        ...
        <script src="<?php echo base_url('/assets/vex/js'); ?>/vex.combined.min.js"></script>
        <script>vex.defaultOptions.className = 'vex-theme-os';</script>
        <link rel="stylesheet" href="<?php echo base_url('/assets/vex/css'); ?>/vex.css" />
        <link rel="stylesheet" href="<?php echo base_url('/assets/vex/css'); ?>/vex-theme-os.css" />
        <style>
        @media only screen
        and (max-width : 480px) {
            .width-set1 {
