...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2014 at 12:21 PM
...
('d0d21d33ce89cdcf363862e2aeb662e2', '::1', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0', 1394104865, ''),
('ec71272dd1d0381eed77d92b22a483a7', '::1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.146 Safari/537.36', 1394097988, '');
...
(1, 'Evaluasi Dosen Oleh Mahasiswa', 'EDOM', '<table>\n<td colspan="3"><h2>LEMBAR EVALUASI DOSEN OLEH MAHASISWA</h2></td></tr>\n<tr><td class="width-set3">Nama Dosen</td><td>: {Nama_Dosen}</td></tr>\n<tr><td>Mata Kuliah</td><td>: {Nama_MK}</td></tr>\n<tr class="padding-line2"><td>Tahun Akademik</td><td>: {tahun}</td></tr>\n</table>\n<table class="bordered">\n<tr><td class="width-set2"></td><td><b>Aspek Yang Dinilai</b></td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td></tr>\n<!--</table>-->'),
(2, 'Kepuasan Mahasiswa', 'KM', '<h2>LEMBAR EVALUASI DOSEN OLEH MAHASISWA</h2>\n<div class="width-set1 subheader">\n<ul>\n<li>Nama Dosen : {Nama_Dosen}</li>\n<li>Mata Kuliah : {Nama_MK}</li>\n<li>Tahun Akademik : {tahun}</li>\n</ul>\n</div>');
